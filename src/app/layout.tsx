...
export const metadata: Metadata = {
  title:
    'HAI Inc. - Thermal Spray Coatings & Equipment | Make it Better, Coat it™',
  description:
    'Leading materials engineering solutions provider for the thermal spraying industry. Thermal spray powders, wires, equipment, and spare parts since 1979.',
  keywords:
    'thermal spray, coating, thermal spray powder, thermal spray wire, equipment, aerospace, automotive, biomedical',
